            ...
            <div class="flex items-center order-3">
                ...
                <div class="relative inline-block ml-1 sm:ml-3">
                    <a data-test="header-icon" href="#" id="customer-menu"
                       class="header-icon block" aria-label="My Account" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                ...
                <a
                    ...
                    id="menu-cart-icon"
                    class="header-icon relative inline-block ml-1 no-underline sm:ml-3 "
                    href="#"
                >
